...
const emit = defineEmits(['close', 'trainerUpdated']);
...
onMounted(() => {
  ...
  phone.value = props.trainer.phone;
  specialization.value = props.trainer.specialization;
  experience.value = props.trainer.experience;
  availability.value = props.trainer.availability || [];
  certifications.value = props.trainer.certifications;
});
...
const updateTrainer = async () => {
  ...
  try {
    const trainerRef = dbRef(db, `branches/${props.branchId}/groups/${props.groupId}/trainers/${props.trainer.id}`);
    ...
    console.error('Eğitmen güncellenirken bir hata oluştu:', e);
    error.value = 'Eğitmen güncellenirken bir hata oluştu';
  } finally {
    loading.value = false;
  }
};
      ...
      <div class="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
        ...
        <div class="sm:flex sm:items-start">
          <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
            <h3 class="text-xl font-semibold leading-6 text-gray-900">Eğitmen Bilgilerini Düzenle</h3>
            <div class="mt-4">
              <form @submit.prevent="updateTrainer" class="space-y-4">
                <!-- İsim -->
                <div>
